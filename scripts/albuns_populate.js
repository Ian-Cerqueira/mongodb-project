db.albuns.insertMany([
  // --- TAYLOR SWIFT (3 Álbuns adicionais) ---
  {
    "Titulo": "Folklore",
  ...
  // --- OUTROS INTERNACIONAIS (Diversidade) ---
  {
    "Titulo": "Bad",
